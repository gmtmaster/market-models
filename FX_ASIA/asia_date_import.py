...
def load_data(file_path="/Users/adamleko/Desktop/forex_algo/MarketModels/data_collect/data/EUR_USD_M15_2025.pkl"):
    
    current_directory = os.getcwd()
    file_path = os.path.join(current_directory, 'data_collect', 'data', 'EUR_USD_M15:2025.pkl')
